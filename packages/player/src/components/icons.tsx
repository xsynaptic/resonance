...
export function SeekBackIcon({ seconds }: { seconds: number }) {
	return (
		<Icon glyphWidth={512} size={20}>
			...
			<SeekCount seconds={seconds} />
		</Icon>
	);
}

export function SeekForwardIcon({ seconds }: { seconds: number }) {
	return (
		<Icon glyphWidth={512} size={20}>
...
function SeekCount({ seconds }: { seconds: number }) {
	return (
		<text
